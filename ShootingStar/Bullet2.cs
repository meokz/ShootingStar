...
namespace Project1 {
    class Bullet2 {
        ...
        public Bullet2() {
            ...
            this.Speed = 5;
            this.Angle = 180;
            handle = DX.LoadGraph("Images/bullet2.png");
        ...
        public bool Hit(Computer com) {
            if (!Active) return false;
            float R = com.r + this.r; // 2つの円の半径の合計
            double X = com.x - this.x - 5; // X座標の差
            double Y = com.y - this.y - 5; // Y座標の差
            if (R * R >= X * X + Y * Y) {
